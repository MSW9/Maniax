...
msw.MakeFrames = function ( )
{
	cc.spriteFrameCache.addSpriteFrames ( "res/sprites.plist", "res/sprites.png" );	
	
	var 	frame = new msw.Frame ( "enemy.small" );	
	frame.SetCoreHitWithRatio ( 0.4, 0.4 );
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "enemy.large.5" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "enemy.xlarge" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "explosion.big", 12 );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "explosion.helix" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "explosion.midas" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "explosion.small", 6 );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "explosion.standard", 16 );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "explosion.blood", 3 );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "explosion.tachyon" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "flare", 21 );
	frame.SetCoreHitWithRatio ( 0.4, 0.4 );
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "projectile.basic" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "projectile.blood" );	
	frame.SetCoreHitWithRatio ( 0.2, 0.4 );
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "projectile.blood.danger" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.boomerang" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.boomerang.danger" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );		
	
	var 	frame = new msw.Frame ( "projectile.brightball" );	
	frame.SetCoreHitWithRatio ( 0.2, 0.4 );
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.chaingun" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.comet" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.dart" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );		
	
	var 	frame = new msw.Frame ( "projectile.dart.danger" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "projectile.helix" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );		
	
	var 	frame = new msw.Frame ( "projectile.laser.drone" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.laser.nightfury" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "projectile.laser.particlebeam" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.laser.pod" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.laser.pod" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );		
	
	var 	frame = new msw.Frame ( "projectile.laser.targeting" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.laser.targeting.2" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );		
	
	var 	frame = new msw.Frame ( "projectile.laser.tiny" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.machinegun" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.massdriver" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.mirvball" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.missile" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.missile.2" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.missile.3" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.missile.4" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.phoenix" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.razor" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.rocket" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.shuriken" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.shuriken.danger" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "projectile.tachyon" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
	
	var 	frame = new msw.Frame ( "projectile.teslabot" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );
	
	var 	frame = new msw.Frame ( "projectile.warp" );	
	msw.Frames.push ( { Frame : frame, Key : frame.Name } );	
/*	
